...
system("cls");
    ...
    cout<<"  "<<"1.  Menu Khen De"<<endl;
      cout<<"  "<<"2.  So much in Love"<<endl;
      cout<<"  "<<"3.  Tonight"<<endl;      
          cout<<"  "<<"4.  Kaun Thuje"<<endl;
            cout<<"  "<<"5.  Cham Cham  (BAAGHI) "<<endl;
              cout<<"  "<<"6.  Dheere Dheere  (HONEY SINGH)"<<endl;              
               cout<<"  "<<"7.  Dil Cheez Thuje Dedi"<<endl;
                    cout<<"  "<<"8.  Beat pe Booty"<<endl;
                    cout<<"  "<<"9.  Naam Hai Tera"<<endl;                   
                      cout<<"  "<<"10. Tera Surror"<<endl;
                       cout<<"  "<<"11.  Samjhona"<<endl;                       
                          cout<<"  "<<"12.  Kala Chasma (BAR BAR DEKHO) "<<endl;
                           cout<<"  "<<"13.  Sanam Re (SANAM RE)"<<endl;
                            cout<<"  "<<"14.  Gerua (DILWALE)"<<endl;
                             ...
                             cout<<"  "<<"16.  Vaada Tainu "<<endl;
                             cout<<"  "<<"17.  Maahi Ve "<<endl;
                             cout<<"  "<<"18.  Bol Har Har "<<endl;
                             cout<<"  "<<"19.  Tera Mera Milna "<<endl;
                             cout<<"  "<<"20.  Bekhudi "<<endl;
                    cout<<setw(50)<<"ENTER YOUR CHOICE   :-";
                    cin>>choice;
                    if(choice==1)
                    PlaySound(TEXT("menu.wav"),NULL,SND_SYNC);
                    else if(choice==2)
                    PlaySound(TEXT("so.wav"),NULL,SND_SYNC);
                    else if(choice==3)
                    PlaySound(TEXT("to.wav"),NULL,SND_SYNC);
                    else if(choice==4)
                    PlaySound(TEXT("kaun.wav"),NULL,SND_SYNC);
                    else if(choice==5)
                    PlaySound(TEXT("chamcham.wav"),NULL,SND_SYNC);
                    else if(choice==6)
                    PlaySound(TEXT("dheeredheere.wav"),NULL,SND_SYNC);
                    else if(choice==7)
                    PlaySound(TEXT("dil.wav"),NULL,SND_SYNC);
                    else if(choice==8)
                    PlaySound(TEXT("bet.wav"),NULL,SND_SYNC);
                    else if(choice==9)
                    PlaySound(TEXT("naam.wav"),NULL,SND_SYNC);
                    else if(choice==10)
                    PlaySound(TEXT("terasur.wav"),NULL,SND_SYNC);
                    else if(choice==11)
                    PlaySound(TEXT("samjo.wav"),NULL,SND_SYNC);
                    else if(choice==12)
                    ...
                    PlaySound(TEXT("vaada.wav"),NULL,SND_SYNC);
                    else if(choice==17)
                    PlaySound(TEXT("mahi.wav"),NULL,SND_SYNC);
                    else if(choice==18)
                    PlaySound(TEXT("shiv.wav"),NULL,SND_SYNC);
                    else if(choice==19)
                    PlaySound(TEXT("tera.wav"),NULL,SND_SYNC);
                    else if(choice==20)
                    PlaySound(TEXT("bekhudi.wav"),NULL,SND_SYNC);
                    }
                    void fun::quiz()
                    {
                          system("COLOR 04");
    ...
    cout<<setw(53)<<"****************************"<<endl<<endl<<endl;
     system("COLOR 04");
    cout<<setw(56)<<"  ||||| BIG MILLIONAIER DAY |||||"<<endl<<endl<<endl;
     system("COLOR 04");
    cout<<setw(56)<<"** SPONSORED BY :- MOHIT Kumar **"<<endl;
    ...
    system("COLOR 2F");
      ...
      cout<<"GENDER (M/F)    :     ";
      cin>>gen;
      PlaySound(TEXT("myfriend.wav"),NULL,SND_SYNC);
      getch();
         system("cls");
          cout<<endl<<endl<<endl;
          system("COLOR 8F");
...
int fun::votes()
            {
                             ...
                             system("COLOR 04");
long q;
char n[100]={"....**** Welcome to Election ****...."};
k=20;
z=0;
while(n[z]!='\0')
{
...
system("cls");
system("COLOR 09");
cout<<setw(50)<<"VOTING STARTS  :"<<endl;
ch='y';
while(ch=='y'||ch=='Y')
{
      ...
      while(q=='y'||q=='Y')
    {
      system("cls");
                           int a,x,y,z;
                             system("COLOR 04");
long q;
char n[100]={"....**** Welcome to our project ****...."};
x=20;
z=0;
while(n[z]!='\0')
{
...
cout<<setw(66)<<"CREATED BY :- MOHIT KUMAR "<<endl<<endl;
